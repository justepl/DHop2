          ...
          <div class="collapse navbar-collapse" >
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active ">
                <a class="nav-link btn btn-secondary disabled" aria-disabled="true" href="annonces.php" id="annonce">Annonces <span class="sr-only">(current)</span></a>
              </li> 
              <li class="nav-item active ">
            ...
            <span class="navbar-text "><a class="nav-link btn btn-secondary" id="aPanier" href="panier.php">panier</a></span>
              <span class="navbar-text"><button class="nav-link btn btn-secondary " id="aConnexion" data-toggle="modal" data-target="#exampleModalCenter">Connexion</button></span>
          </div>
        </nav>
