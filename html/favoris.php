...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
          <a class="navbar-brand" href="#" id="logo">DHop</a>
          ...
          <div class="collapse navbar-collapse" >
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active ">
                <a class="nav-link btn btn-secondary disabled" aria-disabled="true" href="favoris.php" id="favoris">Favoris <span class="sr-only">(current)</span></a>
              </li>           
              <li class="nav-item active ">
